        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image"> 
                        <img src="<?= url('/') . '' ?>/back/dist/img/user-solid.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="<?= url('/') . '/siswa/biodata.html' ?>" class="nav-link <?= ($activemenu == 'biodata') ? 'active' : '' ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= url('/') . '/siswa/berkas.html' ?>" class="nav-link <?= ($activemenu == 'berkas') ? 'active' : '' ?>">
