        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <form id="login" class="white-popup-block">
                    ...
                    <div class="col-md-6 text-right link">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="https://www.instagram.com/skh_salsabilah/">skh_salsabilah</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    success: function(res) {
                        ...
                        if (obj.response == "Success") {
                            Swal.fire({
                                position: 'center',
                                icon: 'success',
                                title: 'Selamat Datang, ' + obj.data.nama_lengkap,
                                showConfirmButton: false,
                                timer: 2000
                            }).then((result) => {
                                if (result.dismiss === Swal.DismissReason.timer) {
                                    location.replace('<?= url('/'); ?>/siswa/biodata.html');
                                }
                            })
                        } else {
                            Swal.fire(
